...
export function GoalForm({ form, onChange, onSave, onCancel, loading, isEdit }: Props) {
  const theme = useTheme()

  const fields: { key: keyof FormState; label: string; keyboard: any }[] = [
    { key: 'name',         label: 'Name',                keyboard: 'default'     },
    { key: 'targetAmount', label: 'Target amount (€)',   keyboard: 'decimal-pad' },
    { key: 'photoUrl',     label: 'Photo URL (optional)', keyboard: 'default'    },
  ]
